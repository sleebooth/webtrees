...
abstract class BaseTheme {
	 ...
	 * @return string
	 */
	protected function flashMessagesContainer() {
		$content = $this->flashMessagesContent();

		if ($content) {
			return '<div id="flash-messages" role="status">' . $this->flashMessagesContent() . '</div>';
		} else {
			return '';
		}
	}
	 ...
	 * @return string
	 */
	protected function flashMessagesContent() {
	 ...
	 * @return string
	 */
	final public function init(WT_Tree $tree = null, Zend_Session_Namespace $session, $search_engine) {
		$this->tree          = $tree;
